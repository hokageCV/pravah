...
import {
  create as habitsCreate,
  destroy as habitsDestroy,
  index as habitsIndex,
  search as habitsSearch,
  show as habitsShow,
} from './group_habits.controllers';
import {
  create as membershipCreate,
  destroy as membershipDestroy,
  index as membershipIndex,
